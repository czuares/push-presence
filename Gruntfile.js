// Generated on 2014-10-12 using generator-chromeapp 0.2.14
'use strict';
  ...
  grunt.initConfig({
    ...
    mocha: {
      all: {
        options: {
          run: true,
          urls: ['http://localhost:<%= connect.options.port %>/options.html']
        }
      }
    },
    ...
    bowerInstall: {
      app: {
        src: ['<%= config.app %>/options.html', '<%= config.app %>/popup.html'],
    ...
    // By default, your `options.html`'s <!-- Usemin block --> will take care of
