        ...
        /**********************
          ...
          **********************/
          var showAlert = function(content, title, type){
            $alert({title: title, content: content, placement: 'top', type: type, show: true});
          };
          ...
          var onlineStateChanged = function(online) {
            if (!online) {
              showAlert('Your computer is not connected to the internet right now. No pushes are going to be sent.', 'Warning','error');
            }
          ...
          var getDevices = function() {
            ...
            PushBullet.devices(function(err, res) {
              if (err) {
                    ...
                    showAlert(msg.error.message,'PushBullet API Error!', 'error');
                    return;
                  }
